...
/* Заголовок функций для реализации Метода Конечных Элементов (МКЭ) в 2D пространстве. Уравнение гиперболическое (с второй производной по времени). Схема для аппроксимации по времени: Кранка-Николсона. Базисные элементы: биквадратичные. Форма сетки: прямоугольники. */
...
struct basic_elem_t
{
	...
	bool is_part_of_elem; // Является ли данный узел началом конечного элемента
